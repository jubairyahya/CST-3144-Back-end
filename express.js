...
// Admin adds lesson
app.post('/admin/lessons', checkAdmin,  async (req, res) => {
  try {
    const { topic, location, price, space,description,image } = req.body;
   
    if (!topic || !location || !price || !space || !image || !description)
